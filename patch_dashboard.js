                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                    {(stats && stats.length > 0 ? stats : [
                      ...
                      return (
                        <div key={i} onClick={() => handleStatClick(stat)} className="relative overflow-hidden p-5 bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-pointer group">
                          {/* Top accent gradient */}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {[
                      ...
                      <div key={i} className="bg-white/60 backdrop-blur-xl p-5 rounded-2xl border border-white shadow-sm flex items-center justify-between">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    {/* Main Chart Area */}
                    <div className="lg:col-span-2 bg-white p-6 rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/40 flex flex-col relative overflow-hidden">
                  ...
                  <div className="bg-white rounded-3xl p-6 border border-slate-100 shadow-xl shadow-slate-200/40">
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <span className="px-3 py-1 bg-indigo-50 text-indigo-700 rounded-lg text-[10px] font-black uppercase tracking-wider border border-indigo-100">Super Admin Only</span>
                    </div>
